...
var FluentUIWidgetManager = /** @class */ (function () {
    function FluentUIWidgetManager(store, objectClass) {
        this.store = store;
    ...
    FluentUIWidgetManager.prototype.inputNumber = function (property, options) {
        ...
        return (React.createElement(fluentui_input_number_1.FluentInputNumber, __assign({}, options, { key: this.getKeyFromProperty(property), defaultValue: value, onEnter: function (value) {
                var _a, _b, _c, _d, _e;
                if (value == null) {
                    _this.emitSetProperty(property, null);
                }
    ...
    FluentUIWidgetManager.prototype.filterEditor = function (options) {
        return (React.createElement(fluentui_filter_1.FilterPanel, { key: options.key, options: __assign({}, options), text: strings_1.strings.filter.filterBy, manager: this }));
    };
    ...
    FluentUIWidgetManager.prototype.nestedChartEditor = function (property, options) {
        ...
        return (React.createElement(React.Fragment, { key: this.getKeyFromProperty(property) }, this.vertical(React.createElement(fluentui_customized_components_1.NestedChartButtonsWrapper, null,
            React.createElement(components_1.ButtonRaised, { text: "Edit Nested Chart...", onClick: function () {
            ...
            React.createElement(components_1.ButtonRaised, { text: "Import Template...", onClick: function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    FluentUIWidgetManager.prototype.verticalGroup = function (options, widgets) {
        return (React.createElement("div", null,
            React.createElement(collapsiblePanel_1.CollapsiblePanel, { header: options.header, widgets: widgets, isCollapsed: options.isCollapsed, alignVertically: options.alignVertically })));
    };
