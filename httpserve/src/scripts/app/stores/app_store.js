    ...
    AppStore.prototype.bindDataToAxis = function (options) {
        ...
        var dataBinding = {
            ...
            orderByCategories: (objectProperties === null || objectProperties === void 0 ? void 0 : objectProperties.orderByCategories) !== undefined
                ...
                : orderByCategories,
            orderByExpression: (_c = objectProperties === null || objectProperties === void 0 ? void 0 : objectProperties.orderByExpression) !== null && _c !== void 0 ? _c : column,
                ...
                case core_1.Specification.DataKind.Ordinal:
                    {
                        ...
                        var _f = this.getCategoriesForDataBinding(dataExpression.metadata, dataExpression.valueType, values), categories = _f.categories, order = _f.order;
                        try {
                            dataBinding.orderByCategories = this.getCategoriesForOrderByColumn(dataBinding.orderByExpression, dataBinding.expression, dataBinding);
                        }
                        catch (e) {
                        ...
                        if (dataBinding.windowSize == null ||
                            ...
                            dataBinding.windowSize = (_e = (_d = dataBinding.allCategories) === null || _d === void 0 ? void 0 : _d.length) !== null && _e !== void 0 ? _e : Math.ceil(categories.length / 10);
                        }
