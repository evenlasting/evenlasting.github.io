...
var Application = /** @class */ (function () {
    ...
    Application.prototype.initialize = function (config, containerID, workerConfig, localizaiton, handlers) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var CurrencySymbol, DelimiterSymbol, GroupSymbol, NumberFormatRemove;
            var _this = this;
