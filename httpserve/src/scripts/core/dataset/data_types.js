...
exports.dataTypes = {
    ...
    date: {
        ...
        convert: function (x) { return datetime_1.parseDate(x); },
    },
    string: {
...
function inferAndConvertColumn(values, localeNumberFormat, hints) {
    var inferredType = inferColumnType(values.filter(function (x) { return x != null; }), localeNumberFormat);
    var convertedValues = convertColumn(inferredType, values, localeNumberFormat);
    if (hints == null) {
        hints = {};
    }
    switch (inferredType) {
