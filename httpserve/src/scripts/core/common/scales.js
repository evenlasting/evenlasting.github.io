...
(function (Scale) {
    ...
    var DateScale = /** @class */ (function (_super) {
        ...
        DateScale.prototype.inferParameters = function (values, nice) {
            ...
            var scale = d3_scale_1.scaleUtc().domain([
        ...
        DateScale.prototype.ticks = function (n) {
            if (n === void 0) { n = 10; }
            var scale = d3_scale_1.scaleUtc().domain([this.domainMin, this.domainMax]);
            return scale.ticks(n).map(function (x) { return x.getTime(); });
        };
        DateScale.prototype.tickFormat = function (n, specifier) {
            if (n === void 0) { n = 10; }
            var scale = d3_scale_1.scaleUtc().domain([this.domainMin, this.domainMax]);
            var fmt = scale.tickFormat(n, specifier);
