...
var Region2DConstraintBuilder = /** @class */ (function () {
    ...
    Region2DConstraintBuilder.prototype.buildSublayoutWidgets = function (m) {
        ...
        if (type == Region2DSublayoutType.DodgeX ||
            ...
            extra.push(m.vertical(m.label(strings_1.strings.alignment.alignment), m.horizontal.apply(m, __spread([[0, 0, 0]], alignmentWidgets.reverse(), [null]))));
            if (type == Region2DSublayoutType.Grid) {
                extra.push(m.vertical(m.label(strings_1.strings.objects.axes.gap), m.vertical(m.label(strings_1.strings.coordinateSystem.x), m.inputNumber({ property: "sublayout", field: "ratioX" }, { minimum: 0, maximum: 1, percentage: true, showSlider: true }), m.label(strings_1.strings.coordinateSystem.y), m.inputNumber({ property: "sublayout", field: "ratioY" }, { minimum: 0, maximum: 1, percentage: true, showSlider: true }))));
            }
            else {
    ...
    Region2DConstraintBuilder.prototype.buildAxisWidgets = function (manager, axisName, axis) {
        ...
        return [
            manager.customCollapsiblePanel(__spread(axis_1.buildAxisWidgets(data, axisProperty, manager, axisName, {
                ...
                showScrolling: true,
                showOnTop: true,
            }, this.updatePlotSegment.bind(this)), this.plotSegment.buildGridLineWidgets(data, manager, axisProperty)), {
