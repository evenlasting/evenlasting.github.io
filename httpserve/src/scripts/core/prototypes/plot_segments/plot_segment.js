...
var PlotSegmentClass = /** @class */ (function (_super) {
     ...
     */
    PlotSegmentClass.prototype.buildGridLineWidgets = function (data, manager, axisProperty) {
        if (!data) {
            return [];
        }
    ...
    PlotSegmentClass.getGridLineAttributePanelWidgets = function (manager, axisProperty) {
        return [
